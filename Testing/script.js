...
const serviceAccount = require("./attack-project-e76d9-firebase-adminsdk-x5c13-a4110daf21.json");
    ...
    fs.createReadStream("./data.csv")
        ...
        .on("data", (data) => {
            ...
            if (data["Start Time / End Time"]) {
                ...
                // Mengambil array Source IP
                let sourceIPs = data["Source IP"].replace(/["]/g, "").split(",");
                ...
                const docData = {
                    ...
                    sourceIp: sourceIPs.map(ip => ip.trim())
                };
        ...
        .on("end", async () => {
            ...
            for (let doc of results) {
                await db.collection("DDoSAttack").add(doc);
            }
